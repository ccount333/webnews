...
function haberVerileriniYukle(id) {
    ...
    const haberVerileri = {
        ...
        4: {
            baslik: 'Yeni grip aşısı tüm hastanelerde ücretsiz yapılacak',
            kategori: 'Sağlık',
            tarih: '14 Mart 2025',
            saat: '10:30',
            yazar: 'Ayşe Kara',
            yazarUnvan: 'Sağlık Muhabiri',
            resim: 'https://via.placeholder.com/800x400?text=Sağlık+Haberi',
            icerik: `<p>Sağlık Bakanlığı tarafından yapılan açıklamada, grip aşısının risk gruplarına ücretsiz yapılacağı belirtildi.</p>
                    <p>Bakanlık yetkililerinden alınan bilgiye göre, 65 yaş üstü vatandaşlar, kronik hastalığı olanlar ve sağlık çalışanları öncelikli gruplar arasında yer alıyor.</p>
                    <p>Aşılama çalışmaları önümüzdeki hafta başlayacak ve tüm hastanelerde ücretsiz olarak uygulanacak.</p>
                    <p>Uzmanlar, özellikle risk grubundaki vatandaşların mutlaka aşı olmalarını tavsiye ediyor.</p>`
        },
        5: {
